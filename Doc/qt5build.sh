...
if [ ! -f "$BASE_DIRECTORY/.sysroot" ]; then
    ...
    rsync -avz pi@raspberrypi.local:/lib $BASE_DIRECTORY/sysroot
    rsync -avz pi@raspberrypi.local:/usr/include $BASE_DIRECTORY/sysroot/usr
    rsync -avz pi@raspberrypi.local:/usr/lib $BASE_DIRECTORY/sysroot/usr
    rsync -avz pi@raspberrypi.local:/opt/vc $BASE_DIRECTORY/sysroot/opt
