/****************************************************************************
** Meta object code from reading C++ file 'thread1.hpp'
**
...
#error "The header file 'thread1.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 13), // "sendtoThread2"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 5), // "count"
QT_MOC_LITERAL(4, 29, 8), // "timerHit"
QT_MOC_LITERAL(5, 38, 19) // "receiveThread2Count"

    },
    "Thread1\0sendtoThread2\0\0count\0timerHit\0"
    "receiveThread2Count"
};
...
void Thread1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Thread1::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread1::sendtoThread2)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Thread1::sendtoThread2(int _t1)
{
